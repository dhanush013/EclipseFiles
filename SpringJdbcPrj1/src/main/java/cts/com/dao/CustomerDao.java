...
public class CustomerDao {
	...
	public int updateCustomer(Customer customer) throws SQLIntegrityConstraintViolationException {
		return jdbcTemplate.update("update customer set customerName=?, customerLocation=? where customerId=?", customer.getCustomerName(),customer.getCustomerLocation(),customer.getCustomerId());
	}
